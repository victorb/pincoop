	...
	render() {
		return <div className="wrapper">
			...
			<div className="content about">
				...
				<p>
					More information can be found in <a href="#">the Github Wiki</a> or at <a href="#">the source itself</a>.
				</p>
				<p>
					OpenIPFS was built and is maintained by<br/>
					Victor Bjelkholm (<a href="#">Twitter</a>, <a href="#">Github</a>)<br/>
					and a group of <a href="#">contributers</a>
				</p>
			</div>
		</div>
	}
